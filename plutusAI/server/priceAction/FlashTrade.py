    ...
    def __init__(self, user_email, index, index_group):
        try:
            ...
            if self.BrokerObject.checkProfile()[MESSAGE]=="SUCCESS":
                ...
                updateFlashConfiguration(user_email=self.user_email, index=self.index_name,
        ...
        while True:
            try:
                ...
                while True:
                    ...
                    if self.IndexLTP >=  self.index_trend_check:
                        # self.CESetTargetAndStopLoss()
                        self.startCE()
                    elif self.IndexLTP <=  self.index_trend_check:
