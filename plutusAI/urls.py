...
urlpatterns = [
    ...
    path(
        ...
        views.get_order_book_details,
        name=GET_ORDER_BOOK_DETAILS,
    ),
    ...
    path(
        TRIGGER_ORDER_TO_MARKET,
        views.modifyToMarketOrderWebHook,
        name=TRIGGER_ORDER_TO_MARKET,
    ),
    path(
        UPDATE_MANUAL_DETAILS,
        views.update_manual_order_values,
        name=UPDATE_MANUAL_DETAILS,
    ),
    ...
    path(
        UPDATE_EXPIRY_DETAILS,
        views.updateIndexExpiryDetails,
        name=UPDATE_EXPIRY_DETAILS,
    ),
    ...
    ##Telegram Settings
    path(
        GET_TELEGRAM_SETTINGS, views.get_telegram_settings, name=GET_TELEGRAM_SETTINGS
    ),
    path(
        UPDATE_TELEGRAM_SETTINGS,
        views.update_telegram_settings,
        name=UPDATE_TELEGRAM_SETTINGS,
    ),
    path(
        "get_telegram_bot_config",
        views.get_telegram_bot_config,
        name="get_telegram_bot_config",
    ),
    path(
        "update_telegram_bot_config",
        views.update_telegram_bot_config,
        name="update_telegram_bot_config",
    ),
